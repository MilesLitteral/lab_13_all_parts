...
print("But the heart will remain")
print("As a silhouette of time")
print("Hear the ringing echos in the splitting horizon")
print("Calling to the night")

print("""But the heart will remain as a silhouette of time hear the reining echos in the splitting horizon calling to the night \n """) * 4

s ='But the heart will remain as a silhouette of time hear the reining echos in the splitting horizon calling to the night'
i = 1
while i < 4
  print s
  ++i
